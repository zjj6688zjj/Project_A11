...
必需参数（两个都要传）:
    --config_file 配置文件路径, 例如: configs/BallShow/rtx4090_final.yml
    --weight      权重文件路径, 例如: logs/BallShow_rtx4090_final/transformer_checkpoint_153.pth

运行示例:
    python test_tta.py --config_file configs/BallShow/rtx4090_final.yml --weight logs/BallShow_rtx4090_final/transformer_checkpoint_153.pth
